...
def create_glove_embedding_init(idx2word, glove_file):
    ...
    for entry in entries:
        ...
        word2emb[word] = np.array(list(vals)).astype( np.float32)
...
if __name__ == '__main__':
    d = create_dictionary('/equilibrium/pietrobongini/VQA/Questions')
    d.dump_to_file('data/dictionary.pkl')

    d = Dictionary.load_from_file('data/dictionary.pkl')
    emb_dim = 300
    glove_file = '/delorean/pietrobongini/glove/glove.6B.%dd.txt' % emb_dim
