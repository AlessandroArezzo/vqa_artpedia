...
infile = '/delorean/pietrobongini/trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv'
train_data_file = '/oblivion/users/pietrobongini/vqa_v2_butd_feats/train36.hdf5'
val_data_file = '/oblivion/users/pietrobongini/vqa_v2_butd_feats/val36.hdf5'
train_indices_file = '/oblivion/users/pietrobongini/vqa_v2_butd_feats/train36_imgid2idx.pkl'
val_indices_file = '/oblivion/users/pietrobongini/vqa_v2_butd_feats/val36_imgid2idx.pkl'
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = utils.load_imageid('/equilibrium/pietrobongini/VQA/Images/mscoco/train2014')
        val_imgids = utils.load_imageid('/equilibrium/pietrobongini/VQA/Images/mscoco/val2014')
    ...
    with open(infile, "r+") as tsv_in_file:
        ...
        for item in tqdm(reader):
            ...
            item['boxes'] = bytes(item['boxes'], encoding='utf8')#.encode('utf')
            item['features'] = bytes(item['features'], encoding='utf8')#.encode('utf')
